        ...
        <h3 class="section-title">使用紀錄</h3>
                <div class="filter-bar">
                  ...
                  <div class="filter-item" @click="toggleProductFilter">
                    ...
                    <img class="arrow" :class="{ 'rotated': showProductDropdown }" src="/assets/imgs/usage/chevron-down.svg" alt="下拉箭頭" />
                  ...
                  <div class="filter-item" @click="toggleYearFilter">
                    ...
                    <img class="arrow" :class="{ 'rotated': showYearDropdown }" src="/assets/imgs/usage/chevron-down.svg" alt="下拉箭頭" />
                  ...
                  <div class="filter-item" @click="toggleMonthFilter">
                    ...
                    <img class="arrow" :class="{ 'rotated': showMonthDropdown }" src="/assets/imgs/usage/chevron-down.svg" alt="下拉箭頭" />
        ...
        margin: 0;
              ...
              .filter-bar {
                ...
                .filter-item {
                  border-radius: 50px;
                  background: #f5f7fa;
                  box-shadow: 2px 4px 12px rgba(177, 192, 216, 0.4);
                  padding: 0.5rem 1rem;
                  display: flex;
                  align-items: center;
                  gap: 6px;
